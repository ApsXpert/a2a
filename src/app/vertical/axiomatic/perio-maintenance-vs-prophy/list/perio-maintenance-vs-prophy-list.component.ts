/**
 * This component is for periodontal maintenance vs prophy list
 */
...
@Component({
    selector: 'perio-maintenance-vs-prophy-list',
    templateUrl: 'perio-maintenance-vs-prophy-list.component.html'
})
export class PMVPListComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.SVP.DOCTOR_YEARLY_REPORTS, this.vlService.vlRequest)
            .subscribe(
                (data: any) => {
