/**
 * This component is for periodontal maintenance vs prophy detail
 */
...
@Component({
    ...
    selector: 'perio-maintenance-vs-prophy-detail',
    templateUrl: 'perio-maintenance-vs-prophy-detail.component.html'
})
export class PMVPDetailComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.SVP.DOCTOR_REPORTS, this.vdcService.vdRequest)
            .subscribe(
