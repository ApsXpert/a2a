/**
 * * This component is for unjustified surgical extraction detail
 */
...
@Component({
    ...
    selector: 'unjustified-surgical-extraction-detail',
    templateUrl: 'unjustified-surgical-extraction-detail.component.html'
})
export class USEDetailComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.USE_A.DOCTOR_REPORTS, this.vdcService.vdRequest)
            .subscribe(
