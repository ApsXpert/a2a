/**
 * This component is for unjustified surgical extraction list
 */
...
@Component({
    selector: 'unjustified-surgical-extraction-list',
    templateUrl: 'unjustified-surgical-extraction-list.component.html'
})
export class USEListComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.USE_A.DOCTOR_YEARLY_REPORTS, this.vlService.vlRequest)
            .subscribe(
                (data: any) => {
