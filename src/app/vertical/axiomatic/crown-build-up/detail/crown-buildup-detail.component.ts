...
@Component({
    ...
    selector: 'crown-buildup-detail',
    templateUrl: 'crown-buildup-detail.component.html'
})
export class CBUDetailComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.CROWN_BUILD_UP.DOCTOR_REPORTS, this.vdcService.vdRequest)
            .subscribe(
