/**
 * This component is for ratio of simple extraction to complex extraction list
 */
...
@Component({
    selector: 'ratio-se-to-ce-list',
    templateUrl: 'ratio-se-to-ce-list.component.html'
})
export class SECEListComponent implements OnInit {
    ...
    constructor(private vlService: VerticalListService, private router: Router, private logout: LogoutService,
                private verticalDetailService: VerticalDetailService, private centralHttpService: CenteralHttpService) {
    }
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centralHttpService.post(URL.SCCD.DOCTOR_YEARLY_REPORTS, this.vlService.vlRequest)
            .subscribe(
                (data: any) => {
