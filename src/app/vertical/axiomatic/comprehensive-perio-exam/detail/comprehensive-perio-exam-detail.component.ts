...
@Component({
    ...
    selector: 'comprehensive-perio-exam-detail',
    templateUrl: 'comprehensive-perio-exam-detail.component.html'
})
export class CPEDetailComponent implements OnInit {
    ...
    constructor(private vdcService: VerticalDetailService, private appDataService: AppDataService,
                private router: Router, private centeralHttpService: CenteralHttpService) {
    }
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.CPE.DOCTOR_REPORTS, this.vdcService.vdRequest)
            .subscribe(
