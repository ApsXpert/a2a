...
@Component({
    selector: 'comprehensive-perio-exam-list',
    templateUrl: 'comprehensive-perio-exam-list.component.html'
})
export class CPEListComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.CPE.DOCTOR_YEARLY_REPORTS, this.vlService.vlRequest)
            .subscribe(
                (data: any) => {
