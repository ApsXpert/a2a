/**
 * This component is for periodontal scaling vs prophy list
 */
...
@Component({
    selector: 'perio-scaling-vs-prophy-list',
    templateUrl: 'perio-scaling-vs-prophy-list.component.html'
})
export class PSVPListComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centralHttpService.post(URL.SRP.DOCTOR_YEARLY_REPORTS, this.vlService.vlRequest)
            .subscribe(
                (data: any) => {
