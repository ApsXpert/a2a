/**
 * This component is for periodontal scaling vs prophy detail
 */
...
@Component({
    ...
    selector: 'perio-scaling-vs-prophy-detail',
    templateUrl: 'perio-scaling-vs-prophy-detail.component.html'
})
export class PSVPDetailComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centralHttpService.post(URL.SRP.DOCTOR_REPORTS, this.vdcService.vdRequest)
            .subscribe(
