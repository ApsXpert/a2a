...
@Component({
    selector: 'full-series-list',
    templateUrl: 'fullseries-xrays-list.component.html'
})
export class FSXListComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.FSX.DOCTOR_YEARLY_REPORTS, this.vlService.vlRequest)
            .subscribe(
                (data: any) => {
