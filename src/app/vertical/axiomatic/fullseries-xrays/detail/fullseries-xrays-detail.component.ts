...
@Component({
    ...
    selector: 'full-series-xrays',
    templateUrl: 'fullseries-xrays-detail.component.html'
})
export class FSXDetailComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.FSX.DOCTOR_REPORTS, this.vdcService.vdRequest)
            .subscribe(
