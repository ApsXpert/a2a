/**
 * This component is for third molar extraction list
 */
...
@Component({
    selector: 'third-molar-extraction-list',
    templateUrl: 'third-molar-extraction-list.component.html'
})
export class TMEListComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centralHttpService.post(URL.THIRD_MOLAR.DOCTOR_YEARLY_REPORTS, this.vlService.vlRequest)
            .subscribe(
                (data: any) => {
