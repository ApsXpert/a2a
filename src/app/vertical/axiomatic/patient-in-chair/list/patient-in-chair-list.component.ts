...
@Component({
    selector: 'patient-in-chair-list',
    templateUrl: 'patient-in-chair-list.component.html'
})
export class PICListComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.PATIENT_IN_CHAIR.DOCTOR_YEARLY_REPORTS, this.vlService.vlRequest)
            .subscribe(
                (data: any) => {
