/**
 * This component is for primary tooth extraction
 */
...
@Component({
    selector: 'primary-tooth-extraction-list',
    templateUrl: 'primary-tooth-extraction-list.component.html'
})
export class PTEListComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centralHttpService.post(URL.PTE.DOCTOR_YEARLY_REPORTS, this.vlService.vlRequest)
            .subscribe(
                (data: any) => {
