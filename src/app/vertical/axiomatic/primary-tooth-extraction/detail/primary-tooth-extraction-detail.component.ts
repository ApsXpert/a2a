/**
 * * This component is for primary tooth extraction detail
 */
...
@Component({
    ...
    selector: 'primary-tooth-extraction-detail',
    templateUrl: 'primary-tooth-extraction-detail.component.html'
})
export class PTEDetailComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centralHttpService.post(URL.PTE.DOCTOR_REPORTS, this.vdcService.vdRequest)
            .subscribe(
