...
@Component({
    ...
    selector: 'multiple-doctor-detail',
    templateUrl: 'multiple-doctor-detail.component.html'
})
export class MDDetailComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centralHttpService.post(URL.MULTIPLE_LOCATIONS.DOCTOR_REPORTS, this.vdcService.vdRequest)
            .subscribe(
