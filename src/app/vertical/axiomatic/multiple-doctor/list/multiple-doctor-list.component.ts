...
@Component({
    selector: 'multiple-doctor-list',
    templateUrl: 'multiple-doctor-list.component.html'
})
export class MDListComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centralHttpService.post(URL.MULTIPLE_LOCATIONS.DOCTOR_YEARLY_REPORTS, this.vlService.vlRequest)
            .subscribe(
                (data: any) => {
