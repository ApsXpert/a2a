...
@Component({
    ...
    selector: 'doctor-with-patient-detail',
    templateUrl: 'doctor-with-patient-detail.component.html'
})
export class DWPDetailComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.PATIENT_IN_CHAIR.DOCTOR_REPORTS, this.vdcService.vdRequest)
            .subscribe(
