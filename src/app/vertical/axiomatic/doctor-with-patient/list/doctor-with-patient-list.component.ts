...
@Component({
    selector: 'doctor-with-patient-list',
    templateUrl: 'doctor-with-patient.component.html'
})
export class DWPListComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.DOCTOR_WITH_PATIENT.DOCTOR_YEARLY_REPORTS, this.vlService.vlRequest)
            .subscribe(
                (data: any) => {
