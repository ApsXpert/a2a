/**
 * * This component is for multiple doctor/ multiple location detail
 */
...
@Component({
    ...
    selector: 'over-active-detail',
    templateUrl: 'over-active-detail.component.html'
})
export class OverActiveDetailComponent implements OnInit {
    ...
    public pageChanged(pageNumber: any) {
        ...
        this.centeralHttpService.post(URL.OVER_ACTIVE.DOCTOR_REPORTS, this.vdcService.vdRequest)
            .subscribe(
    ...
    public searchByMID() {
        this.appDataService.loadingFlag = true;
        this.vdcService.vdRequest.searchBymid = this.mid;
